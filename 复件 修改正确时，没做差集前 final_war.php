	...
	<?php
		...
		*/
		...
		echo '<div id="method_line">';
			...
			// echo '正在进行分析的数组为：<br>';
			echo '正在进行分析的数组为：<font color="#aaggss" size="5px">';
			for($j=0; $j<6; $j++){
			...
			echo '数组的下一组数据为：<font color="#aaggss" size="5px">';
			for($j=0; $j<6; $j++){
